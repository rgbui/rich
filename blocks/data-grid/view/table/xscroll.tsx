...
import { DataGridTableHead } from "./content";
import { BlockUrlConstant } from "../../../../src/block/constant";

export class ScrollXDataGrid extends React.Component<{
    ...
    render() {
        ...
        if (!isScrollX) return <div>
            {this.props.block.schema && this.block.noHead !== true && <div
                ref={e => {
                    this.headScrollEl = e;
                    this.bindScroll();
                }}
        ...
        var sumWidth = props.block instanceof TableStore ? props.block.sumWidth : undefined;
        if (typeof this.blockWidth == 'number' && sumWidth < this.blockWidth) {
            sumWidth = this.blockWidth;
        }
        return <div ref={e => this.sx = e}>
            {this.props.block.schema && this.props.block.noHead !== true && <div
                ref={e => {
                    this.headScrollEl = e;
                    this.bindScroll();
                }}
