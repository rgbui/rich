    ...
    renderGroup(dg: ArrayOf<TableStoreBoard['dataGroups']>, index: number) {
        ...
        return <div className="sy-data-grid-board-group visible-hover" key={index}>
            <div className="sy-data-grid-board-group-head">
                <span className="flex-auto"><span className="text-overflow padding-w-6 f-14 padding-h-2  l-16" style={{ backgroundColor: dg.color || undefined }}>{dg.group || lst('未定义')}</span><label>{ds?.count}</label></span>
