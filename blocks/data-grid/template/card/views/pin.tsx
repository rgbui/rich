...
CardModel('/card/pinterest', () => ({
    ...
    props: [
        ...
        { name: 'createDate', text: lst('创建时间'), types: [FieldType.createDate] },
    ...
    render() {
        ...
        if (cs.cardDisplay == 'card-1') {
            ...
            return <div className="w100" onMouseDown={e => self.openEdit(e)}>
                ...
                {tags && tags.length > 0 && <div className="  gap-h-5 flex">
                    {tags.map((t, i) => {
                ...
                <div className="text-1  f-14 gap-h-5 flex">
                    ...
                    {this.exists('like') && <div className="flex-auto flex-end">
