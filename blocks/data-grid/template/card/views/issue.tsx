...
CardModel({
    ...
    props: [
        ...
        { name: 'handler', text: lst("处理人"), types: [FieldType.user] },
        { name: 'autoIncrement', text:lst( "编号"), types: [FieldType.autoIncrement] },
        { name: 'tags', text: lst('分类'), types: [FieldType.options, FieldType.option] },
        { name: 'status', text:lst( '状态'), types: [FieldType.option, FieldType.options] },
    ...
    views: [
        { url: BlockUrlConstant.DataGridTable, text:lst( '事项'), },
        { autoCreate: true, url: BlockUrlConstant.DataGridList, text:lst( '事项列表'), },
        { url: BlockUrlConstant.RecordPageView, text:lst( '事项详情') }
    ],
    dataList: [
