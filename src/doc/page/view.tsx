...
export class PageView extends Component<{ page: Page }> {
    ...
    render() {
        ...
        return <div className='kanhai-page-view' style={pageStyle} tabIndex={1} onKeyDown={this.page.onKeydown.bind(this.page)}><PageLayoutView pageLayout={this.page.pageLayout}>
