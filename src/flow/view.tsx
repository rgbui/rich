...
export class FlowView extends React.Component<{ flow: Flow }> {
    ...
    render() {
        return <div onMouseDown={e => e.stopPropagation()}>
            ...
            {this.renderCommands()}
            <div className="flex remark item-hover round padding-w-5 h-30 cursor " onMouseDown={e => this.props.flow.openAddStep(e)} ><span className="flex-center    round"><Icon size={18} icon={PlusSvg}></Icon><span><S>添加下一步骤</S></span></span></div>
        </div>
    }
}