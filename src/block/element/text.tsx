...
import { Edit1Svg, EditSvg, LinkSvg, TrashSvg } from "../../../component/svgs";
        ...
        if (this.block.link) {
            if (this.block.link.name == 'page' && !this.block.link.pageId) {
                ...
                ta = <BoxTip placement="bottom" overlay={<div className="flex-center">
                    <ToolTip overlay={'/page/' + this.block.link.pageId}><a className="flex-center size-24 round item-hover gap-5 cursor"><Icon size={14} icon={LinkSvg}></Icon></a></ToolTip>
                    ...
                    <ToolTip overlay={'取消'}><a className="flex-center size-24 round item-hover gap-5 cursor"><Icon size={14} icon={TrashSvg}></Icon></a></ToolTip>
                ...
                ta = <BoxTip placement="bottom" overlay={<div className="flex-center">
                    <ToolTip overlay={this.block.link.url}><a className="flex-center size-24 round item-hover gap-5 cursor"><Icon size={14} icon={LinkSvg}></Icon></a></ToolTip>
                    <ToolTip overlay={'编辑'}><a className="flex-center size-24 round item-hover gap-5 cursor"><Icon size={18} icon={EditSvg}></Icon></a></ToolTip>
                    <ToolTip overlay={'取消'}><a className="flex-center size-24 round item-hover gap-5 cursor"><Icon size={14} icon={TrashSvg}></Icon></a></ToolTip>
