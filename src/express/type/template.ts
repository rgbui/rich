...
DeclareTypes.registerType('string', 'replace', { __args: ['string', 'string'], __returnType: 'string' }, '$this.replaceAll($args1,$args2)');
...
DeclareTypes.registerStatic('Math.random', { __args: ['int', 'int'], __returnType: 'int' }, 'Math.ceil(Math.random() * ($args1-$args2+1) + $args2-1)', [{ name: 'random', code: 'import random' }])
DeclareTypes.registerStatic('Math.max', { __args: [{ __unit: 'number', __extensible: true }], __returnType: 'int' }, 'Math.max($args1,$args2)', [{ name: 'random', code: 'import random' }])
DeclareTypes.registerStatic('Math.min', { __args: [{ __unit: 'number', __extensible: true }], __returnType: 'int' }, 'Math.min($args1,$args2)', [{ name: 'random', code: 'import random' }])
...
DeclareTypes.registerStatic('Math.abs', { __args: ['number'], __returnType: 'number' }, 'Math.abs($args1)', [{ name: 'math', code: 'import math' }])
...
DeclareTypes.registerStatic('isEmpty', { __args: ['string'], __returnType: 'bool' }, `$args1===""`)
 ...
 *
 */
DeclareTypes.registerStatic('Date.now', 'date', 'new Date()', [{ name: 'datetime', code: 'from datetime import datetime' }]);
