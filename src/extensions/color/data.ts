...
export var FontColorList = [
    { color: 'rgb(33, 37, 41)', text: '默认' },
    { color: 'rgba(55, 53, 47, 0.6)', text: '灰色' },
    { color: 'rgb(100, 71, 58)', text: '棕色' },
    { color: 'rgb(217, 115, 13)', text: '橙色' },
    { color: 'rgb(223, 171, 1)', text: '黄色' },
    { color: 'rgb(15, 123, 108)', text: '绿色' },
    { color: 'rgb(11, 110, 153)', text: '蓝色' },
    { color: 'rgb(105, 64, 165)', text: '紫色' },
    { color: 'rgb(173, 26, 114)', text: '粉色' },
    { color: 'rgb(224, 62, 62)', text: '红色' }
];
/**
 * 背景色
 */
