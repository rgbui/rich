...
export interface ChannelSyncMapUrls {
    "/log":{args:(r:{type:"error"|"warn"|"info",message:string|Error},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/page/update/info":{args:(r:{id?: string,elementUrl?:string, pageInfo:LinkPageItem},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/page/remove":{args:(r:{item:string|{id:string}},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/update/user":{args:(r:{user: Record<string, any>},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/page/create/sub":{args:(r:{pageId:string,text:string},options?:{locationId?:string|number,sockId?:string,userid?:string})=>LinkPageItem,returnType:void},
	"/schema/operate":{args:(r:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}},options?:{locationId?:string|number,sockId?:string,userid?:string})=>SockResponse<{actions:any[]}>,returnType:void},
	"/datastore/operate":{args:(r:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}},options?:{locationId?:string|number,sockId?:string,userid?:string})=>SockResponse<{actions:any[]}>,returnType:void},
	"/user/basic/sync":{args:(r:{id:string},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/user/onlines":{args:(r:{users:Set<string>},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/user/view/onlines":{args:(r:{viewUrl:string,users:Set<string>},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/channel/notify":{args:(r:{id:string,workspaceId:string,roomId:string},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/channel/patch/notify":{args:(r:{ workspaceId: string,roomId: string,content: string,file: any,isEdited:boolean},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/channel/deleted/notify":{args:(r:{ workspaceId: string,id:string,roomId:string},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/channel/emoji/notify":{args:(r:{workspaceId: string,id: string,roomId: string,emoji:{ emojiId: string, code?: string }},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/view/operate/notify":{args:(r:UserAction,options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/view/operates/notify":{args:(r:UserAction[],options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/page/item/operate/notify":{args:(r:{id:string,workspaceId:string,roomId:string},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/ws/datagrid/schema/operate/notify":{args:(r:{id:string,workspaceId:string,roomId:string},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void},
	"/row/block/sync/refs/notify":{args:(r:{pageId?:string,operators:any[]},options?:{locationId?:string|number,sockId?:string,userid?:string})=>void,returnType:void}
}
export interface ChannelOnlyMapUrls {
	...
	"/schema/operate":{args:(r:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}})=>SockResponse<{actions:any[]}>,returnType:void},
	"/datastore/operate":{args:(r:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}})=>SockResponse<{actions:any[]}>,returnType:void},
...
export interface ChannelFireMapUrls {
	...
	"/schema/operate":{args:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}},returnType:SockResponse<{actions:any[]}>},
	"/datastore/operate":{args:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}},returnType:SockResponse<{actions:any[]}>},
...
export interface ChannelDelMapUrls {
	...
	"/delete/page/ref":{args:{ws:LinkWs,wsId?:string,id:string},returnType:Promise<SockResponse<void>>}
}
export interface ChannelPostMapUrls {
	...
	"/text/ai/stream":{args:{question: string,role?:string, model?: WsConsumeType, uid?: string, options?: Record<string, any>,callback:(str:string,done?:boolean,controller?:AbortController,abort?:boolean)=>void},returnType:Promise<SockResponse<void>>},
	...
	"/create/workspace/template":{args:{config?:Record<string,any>,file: ResourceArguments,childs?:any[], wsId: string, pageId?: string, elementUrl:string, templateUrl: string, text?: string,icon?:any, description?: string,pageType?:any, type:"workspace"|"dir"|"page"},returnType:Promise<SockResponse<void>>},
...
export interface ChannelGetMapUrls {
	...
	"/datastore/stat/fields":{args:{groupFilters?: { id: string, filter: Record<string, any> }[],ws:LinkWs,wsId?:string,schemaId:string,stats:{fieldId:string,stat:string}[],filter?:Record<string,any>},returnType:Promise<{ok:boolean,data:{stats?:{fieldId:string,stat:string,value:number,total?:number}[],groupStats?:({fieldId:string,stat:string,value:number,total?:number}[])[]},warn:string}>},
	"/datastore/board/statistics":{args:{ws:LinkWs,wsId?:string,schemaId:string,group?:string,page?:number,size?:number,filter?:Record<string, any>,sorts?:Record<string, 1|-1>,hideGroups?:string[],isIgnoreEmpty?:boolean,isStatTotal?: boolean,},returnType:Promise<{ok:boolean,data:{list:{id:string,list:any[],total?:number}[]},warn:string}>},
	...
	"/datastore/exists/user/submit":{args:{ws:LinkWs,wsId?:string,schemaId:string},returnType:Promise<SockResponse<{data:Record<string,any>,total?:number}>>},
...
export interface ChannelActMapUrls {
	...
	"/page/open":{args:{item?: string | { id: string }, elementUrl?: string,config?:{isTemplate?:boolean,wait?:boolean,blockId?:string,force?:boolean,initData?:Record<string,any>,isCanEdit?:boolean,createItemForm?:boolean|string}},returnType:void},
	"/page/dialog":{args:{elementUrl:string,config?:{isTemplate?:boolean,wait?:boolean,blockId?:string,force?:boolean,initData?:Record<string,any>,isCanEdit?:boolean,createItemForm?:boolean}},returnType:any},
	"/page/slide":{args:{elementUrl:string,config?:{isTemplate?:boolean,wait?:boolean,blockId?:string,force?:boolean,initData?:Record<string,any>,isCanEdit?:boolean,createItemForm?:boolean}},returnType:any},
