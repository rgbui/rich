...
export interface ChannelSyncMapUrls {
	...
	"/user/view/onlines":{args:(r:{viewId:string,users:Set<string>})=>void,returnType:void},
...
export interface ChannelFireMapUrls {
	...
	"/user/view/onlines":{args:{viewId:string,users:Set<string>},returnType:void},
...
export interface ChannelPatchMapUrls {
	...
	"/ws/channel/patch":{args:{id: string,sockId?: string,wsId?: string,roomId: string,content?: string,replyId?: string,file?:any,isEdited?:boolean},returnType:Promise<SockResponse<void>>},
...
export interface ChannelPutMapUrls {
	...
	"/ws/channel/send":{args:{ sockId?: string,wsId?: string,roomId: string,content?: string,replyId?: string, files?:any[],mentions?:string[],robotId?:string},returnType:Promise<SockResponse<{id:string,seq:number,createDate:Date}>>},
...
export interface ChannelGetMapUrls {
	...
	"/ws/query":{args:{name?:string},returnType:Promise<SockResponse<{workspace:Record<string,any>,pids:any[]}>>},
...
export interface ChannelQueryMapUrls {
	...
	"/user/get/onlines":{args:{wsId?:string},returnType:{users:Set<string>}},
	"/user/get/view/onlines":{args:{viewId:string},returnType:{users:Set<string>}},
