...
export interface ChannelSyncMapUrls {
	...
	"/user/order/notify":{args:(r:{id:string, subject: string,body: string, price: number,count: number,amount: number,kind: string})=>void,returnType:void},
...
export interface ChannelFireMapUrls {
	...
	"/user/order/notify":{args:{id:string, subject: string,body: string, price: number,count: number,amount: number,kind: string},returnType:void},
...
export interface ChannelPutMapUrls {
	...
	"/create/qr_pay/order":{args:{subject: string,body: string,price: number,count: number,amount?: number,kind: string},returnType:Promise<SockResponse<{orderId:string}>>},
