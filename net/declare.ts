...
export interface ChannelGetMapUrls {
	...
	"/datastore/statistics/value":{args:{ws:LinkWs,wsId?:string,schemaId:string,filter?:Record<string, any>,indicator:string},returnType:Promise<{ok:boolean,data:{value:number},warn:string}>},
