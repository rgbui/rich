...
export interface ChannelSyncMapUrls {
	...
	"/page/update/info":{args:(r:{id?: string,elementUrl?:string, pageInfo:LinkPageItem},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/page/remove":{args:(r:{item:string|{id:string}},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/update/user":{args:(r:{user: Record<string, any>},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/page/create/sub":{args:(r:{pageId:string,text:string},options?:{locationId?:string|number,sockId?:string})=>LinkPageItem,returnType:void},
	"/schema/operate":{args:(r:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}},options?:{locationId?:string|number,sockId?:string})=>SockResponse<{actions:any[]}>,returnType:void},
	"/datastore/operate":{args:(r:{operate:{operate?:string,schemaId:string,date?:Date,actions:any[]}},options?:{locationId?:string|number,sockId?:string})=>SockResponse<{actions:any[]}>,returnType:void},
	"/user/basic/sync":{args:(r:{id:string},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/user/onlines":{args:(r:{users:Set<string>},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/user/view/onlines":{args:(r:{viewUrl:string,users:Set<string>},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/ws/channel/notify":{args:(r:{id:string,workspaceId:string,roomId:string},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/ws/channel/patch/notify":{args:(r:{ workspaceId: string,roomId: string,content: string,file: any,isEdited:boolean},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/ws/channel/deleted/notify":{args:(r:{ workspaceId: string,id:string,roomId:string},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
	"/ws/channel/emoji/notify":{args:(r:{workspaceId: string,id: string,roomId: string,emoji:{ emojiId: string, code?: string }},options?:{locationId?:string|number,sockId?:string})=>void,returnType:void},
