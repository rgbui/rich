...
export interface ChannelPostMapUrls {
	...
	"/text/ai/stream":{args:{question: string, model?: string, uid?: string, options?: Record<string, any>,callback:(str:string,done?:boolean,controller?:AbortController)=>void},returnType:Promise<SockResponse<void>>},
...
export interface ChannelGetMapUrls {
	...
	"/page/query/info":{args:{ ws?: LinkWs, id?: string,elementUrl?:string},returnType:Promise<SockResponse<LinkPageItem>>},
	...
	"/query/wiki/answer":{args:{ask: string,model:string, robotId: string,size?:number,contextSize?:number},returnType:Promise<SockResponse<{docs:{contentId:string,docId:string,ps:{at:number,content:string,contentId:string,rank:number}[]}[]}>>},
	...
	"/ws/channel/abled/send":{args:{ws:LinkWs,wsId?:string,roomId:string,pageId:string},returnType:Promise<SockResponse<{abled:boolean}>>},
