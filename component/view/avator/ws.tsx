    ...
    render() {
        ...
        function getFlags() {
            return <div className="shy-ws-avatar-flag">
                ...
                <svg style={{ color: '#fff',marginTop:2 }} aria-hidden="false" width="16" height="16" viewBox="0 0 16 15.2"><path d="M7.4,11.17,4,8.62,5,7.26l2,1.53L10.64,4l1.36,1Z" fill="currentColor"></path></svg>
            </div>
        }
        return <div className="shy-ws-avatar">
            <div className="shy-ws-avatar-cover">
                {this.ws.cover && <img src={this.ws.cover.url} />}
                {!this.ws.cover && <div style={{ height: 153, backgroundColor: 'rgb(192, 157, 156)' }}></div>}
            </div>
            <div className="shy-ws-avatar-face">
                {this.ws.icon && <img src={this.ws.icon.url} />}
