...
export class DataGridViewConfig extends EventsComponent {
    ...
    getItems(): MenuItem[] {
        var baseItems: MenuItem[] = [
            ...
            { text: '勾选', type: MenuItemType.switch, checked: (this.block as TableStore).showCheckRow, name: 'showCheckRow' },
        ...
        baseItems.insertAt(5, ...[
            ...
            { text: '表头', name: 'noHead', type: MenuItemType.switch, checked: (this.block as TableStore).noHead ? false : true },
        ])
        return baseItems
    }
    renderItems() {
