    ...
    renderCustom() {
        ...
        return <div className="padding-w-10">
            ...
            <div className="flex r-gap-r-10 r-round-2">
                ...
                <Tip text='背景布局' ><div className={"round padding-5 " + (this.pageTheme?.coverStyle?.display == 'inside' ? " item-hover-focus" : "item-hover")}><div className="cursor round" onMouseDown={e => this.setTheme('coverStyle.display', 'inside')} style={{ border: this.pageTheme?.coverStyle?.display == 'inside' ? solid : '2px solid #cac5c4', width: 30, height: 20, background: this.pageTheme?.coverStyle?.display == 'inside' ? textp : '#cac5c4' }}></div></div></Tip>
                <Tip text='Top布局' ><div className={"round padding-5 " + (this.pageTheme?.coverStyle?.display == 'inside-cover' ? " item-hover-focus" : " item-hover")}><div className="cursor round" onMouseDown={e => this.setTheme('coverStyle.display', 'inside-cover')} style={{ border: this.pageTheme?.coverStyle?.display == 'inside-cover' ? solid : '2px solid #cac5c4', width: 30, height: 20 }}><div style={{ background: this.pageTheme?.coverStyle?.display == 'inside-cover' ? textp : '#cac5c4', height: 6 }}></div></div></div></Tip>
                <Tip text='Left布局'><div className={"round padding-5 " + (this.pageTheme?.coverStyle?.display == 'inside-cover-left' ? " item-hover-focus" : " item-hover")}><div className="cursor flex round" onMouseDown={e => this.setTheme('coverStyle.display', 'inside-cover-left')} style={{ border: this.pageTheme?.coverStyle?.display == 'inside-cover-left' ? solid : '2px solid #cac5c4', width: 30, height: 20 }} ><div style={{ background: this.pageTheme?.coverStyle?.display == 'inside-cover-left' ? textp : '#cac5c4', width: 10, height: 20 }}></div></div></div></Tip>
                <Tip text='Right布局' ><div className={"round padding-5 " + (this.pageTheme?.coverStyle?.display == 'inside-cover-right' ? " item-hover-focus" : " item-hover")}><div className="cursor flex-end round" onMouseDown={e => this.setTheme('coverStyle.display', 'inside-cover-right')} style={{ border: this.pageTheme?.coverStyle?.display == 'inside-cover-right' ? solid : '2px solid #cac5c4', width: 30, height: 20 }} ><div style={{ background: this.pageTheme?.coverStyle?.display == 'inside-cover-right' ? textp : '#cac5c4', width: 10, height: 20 }}></div></div></div></Tip>
            </div>
