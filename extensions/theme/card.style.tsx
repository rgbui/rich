    ...
    render() {
        ...
        return <div ref={e => this.el = e} className="round padding-10">
            <div className="flex  " >
                ...
                <Tip text='背景布局' ><div className={"round gap-r-10 padding-5 r-round " + (this.cardThemeStyle?.coverStyle?.display == 'inside' ? "item-hover-focus" : "item-hover")}><div className="cursor " onMouseDown={e => this.setTheme('coverStyle.display', 'inside')} style={{ border: this.cardThemeStyle?.coverStyle?.display == 'inside' ? solid : '2px solid #cac5c4', width: 30, height: 20, background: this.cardThemeStyle?.coverStyle?.display == 'inside' ? textp : '#cac5c4' }}></div></div></Tip>
