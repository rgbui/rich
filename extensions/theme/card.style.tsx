...
export class CardBoxStyle extends EventsComponent {
    ...
    render() {
        ...
        return <div ref={e => this.el = e} className="round padding-10">
            <div className="flex  " >
                <Tip text='无布局'><div className={"round gap-r-10 padding-5 r-round " + ((this.cardThemeStyle?.coverStyle?.display || 'none') == 'none' ? "item-hover-focus" : "item-hover")}><div className="cursor " onMouseDown={e => this.setTheme('coverStyle.display', 'none')} style={{ border: (this.cardThemeStyle?.coverStyle?.display || 'none') == 'none' ? solid : '2px solid #cac5c4', width: 30, height: 20 }}></div></div></Tip>
                <Tip text='背景布局' ><div className={"round gap-r-10 padding-5 r-round " + (this.cardThemeStyle?.coverStyle?.display == 'inside' ? "item-hover-foucs" : "item-hover")}><div className="cursor " onMouseDown={e => this.setTheme('coverStyle.display', 'inside')} style={{ border: this.cardThemeStyle?.coverStyle?.display == 'inside' ? solid : '2px solid #cac5c4', width: 30, height: 20, background: this.cardThemeStyle?.coverStyle?.display == 'inside' ? textp : '#cac5c4' }}></div></div></Tip>
                <Tip text='Top布局' ><div className={"round gap-r-10 padding-5 r-round " + (this.cardThemeStyle?.coverStyle?.display == 'inside-cover' ? "item-hover-focus" : "item-hover")}><div className="cursor " onMouseDown={e => this.setTheme('coverStyle.display', 'inside-cover')} style={{ border: this.cardThemeStyle?.coverStyle?.display == 'inside-cover' ? solid : '2px solid #cac5c4', width: 30, height: 20 }}><div style={{ background: this.cardThemeStyle?.coverStyle?.display == 'inside-cover' ? textp : '#cac5c4', height: 6 }}></div></div></div></Tip>
                <Tip text='Left布局'><div className={"round gap-r-10 padding-5 r-round " + (this.cardThemeStyle.coverStyle?.display == 'inside-cover-left' ? "item-hover-focus" : "item-hover")}><div className="cursor flex  " onMouseDown={e => this.setTheme('coverStyle.display', 'inside-cover-left')} style={{ border: this.cardThemeStyle.coverStyle?.display == 'inside-cover-left' ? solid : '2px solid #cac5c4', width: 30, height: 20 }} ><div style={{ background: this.cardThemeStyle?.coverStyle?.display == 'inside-cover-left' ? textp : '#cac5c4', width: 10, height: 20 }}></div></div></div></Tip>
                <Tip text='Right布局' ><div className={"round gap-r-10 padding-5 r-round " + (this.cardThemeStyle?.coverStyle?.display == 'inside-cover-right' ? "item-hover-focus" : "item-hover")}><div className="cursor flex-end" onMouseDown={e => this.setTheme('coverStyle.display', 'inside-cover-right')} style={{ border: this.cardThemeStyle?.coverStyle?.display == 'inside-cover-right' ? solid : '2px solid #cac5c4', width: 30, height: 20 }} ><div style={{ background: this.cardThemeStyle?.coverStyle?.display == 'inside-cover-right' ? textp : '#cac5c4', width: 10, height: 20 }}></div></div></div></Tip>
            </div>
