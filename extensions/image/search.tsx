...
export class ImageGallery extends React.Component<{
    ...
    render() {
        return <div className='shy-third-gallery'>
            <div className="shy-third-gallery-search"><Input value={this.word} onChange={e => this.word = e} onEnter={e => { this.word = e; this.onSearch() }} clear placeholder={'图片搜索...'}></Input></div>
            <div className='shy-third-gallery-content'>
                ...
                {this.error && this.pics.length == 0 && <div className='shy-third-gallery-error'><span>图片资源获取失败</span><a onClick={e => this.onSearch()}>重新尝试</a></div>}
            </div>
        </div>
    }
}