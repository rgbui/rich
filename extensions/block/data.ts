    ...
    var BlockSelectorData: BlockGroup[] = [
        {
            ...
            childs: [
                ...
                { text: lst('四级标题'), icon: H4Svg, url: '/head?{level:"h4"}', description: '', label: lst('/四级标题'), labels: ['/bt', lst('/标题'), '/biaoti', '/head', '/h4'] },
                ...
                { text: lst("折叠列表"), icon: ToggleListSvg, url: '/list?{listType:2}', description: lst("折叠列表"), label: lst('/折叠列表'), labels: ['/zdlb', '/toggle'] },
