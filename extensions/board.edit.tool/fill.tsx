...
export function ShapeFill(props: { fillColor: string, fillOpacity: number, change: (name: string, value: any) => void }) {
    ...
    function renderSvg() {
        ...
        else return <a style={{ display: 'inline-block', width: 'inherit', height: 'inherit', borderRadius: '50%', backgroundColor: props.fillColor }}></a>
    }
    return <div className="shy-shape-fill">
        ...
        {visible && <div className="shy-shape-fill-drops">
            <div className="shy-shape-fill-opacity">
                <MeasureView min={0} ratio={0.1} max={10} showValue={false} value={props.fillOpacity} onChange={e => { props.change('fillOpacity', e) }}></MeasureView>
            </div>
